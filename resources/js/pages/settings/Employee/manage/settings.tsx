...
export function EmployeeSettings({ employee, employmentStatuses, offices }: EmployeeSettingsProps) {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>Update employee details and settings</CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <div className="flex flex-col items-center space-y-4 md:col-span-1">
                            ...
                            >
                                {photoPreviewUrl ? (
                                    ...
                                    <img src={employee.image_path} alt="Current" className="h-full w-full object-cover" />
                                ) : (
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                <Button type="button" variant="outline" size="sm" onClick={() => document.getElementById('photo-edit')?.click()}>
                                    <UploadIcon className="mr-1 size-4" />
                                    {photoPreviewUrl || employee.image_path ? 'Change' : 'Choose'}
                                </Button>

                                {(photoPreviewUrl || employee.image_path) && (
                                    <Button
                                        type="button"
                                        variant="destructive"
                                        size="sm"
                        ...
                        <div className="space-y-4 md:col-span-2">
                            ...
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                <div className="flex w-full flex-col gap-1">
                                    ...
                                    <Select value={data.employment_status_id} onValueChange={handleEmploymentStatusChange}>
                                        <SelectTrigger className="w-full">
